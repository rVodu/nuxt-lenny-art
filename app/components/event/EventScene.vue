<template>
  <div class="event-scene">
    <div class="event-scene__container">
      <h4 class="event-scene__title">Сцена</h4>
      <div class="event-scene__wrapper">
        <svg class="event-scene__scene scene" width="780" height="399" viewBox="0 0 780 399" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <svg class="scene" width="780" height="399" viewBox="0 0 780 399" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            ...
            <g class="event-scene__table" :class="{
              ...
              <path class="event-scene__table-num"
            ...
            }" data-check="table_2" @click="onClick(2)">
            ...
            }" data-check="table_3" @click="onClick(3)">
              <g class="event-scene__table-group" stroke="#1F1E1E">
            ...
            }" data-check="table_4" @click="onClick(4)">
              <g class="event-scene__table-group" stroke="#BC3324">
            ...
            }" data-check="table_5" @click="onClick(5)">
              <g class="event-scene__table-group" stroke="#1F1E1E">
            ...
            }" data-check="table_6" @click="onClick(6)">
              <g class="event-scene__table-group" stroke="#1F1E1E">
            ...
            <g class="event-scene__table" :class="{
            ...
            }" data-check="table_7" @click="onClick(7)">
              <g class="event-scene__table-group" stroke="#BC3324">
              ...
              <path class="event-scene__table-num"
                d="M358.041 204L362.943 192.916H356.762V189.723H367.064V191.998L362.035 204H358.041Z" fill="#BC3324" />
            ...
            }" data-check="table_8" @click="onClick(8)">
              <g class="event-scene__table-group" stroke="#BC3324">
            ...
            }" data-check="table_9" @click="onClick(9)">
              <g class="event-scene__table-group" stroke="#BC3324">
            ...
            }" data-check="table_10" @click="onClick(10)">
              <g class="event-scene__table-group" stroke="#1F1E1E">
            ...
            }" data-check="table_11" @click="onClick(11)">
              <g class="event-scene__table-group" stroke="#1F1E1E">
